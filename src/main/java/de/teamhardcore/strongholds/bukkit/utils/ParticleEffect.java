...
public enum ParticleEffect {
    ...
    private static boolean isLongDistance(Location location, List<Player> players) {
        ...
        for (Player player : players) {
            ...
            if (!world.equals(playerLocation.getWorld().getName()) || playerLocation
                    .distanceSquared(location) < 65536.0D) {
                continue;
            }
            return true;
        }
    ...
    public void display(ParticleData data, Vector direction, float speed, Location center, List<Player> players) throws ParticleVersionException, ParticleDataException {
        ...
        (new ParticlePacket(this, direction, speed, isLongDistance(center, players), data))
                .sendTo(center, players);
    }
    ...
    public static final class ParticlePacket {
        ...
        public ParticlePacket(ParticleEffect effect, ParticleEffect.ParticleColor color, boolean longDistance) {
            ...
            if (effect == ParticleEffect.REDSTONE && color instanceof ParticleEffect.OrdinaryColor && ((ParticleEffect.OrdinaryColor) color)
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                version = Integer.parseInt(Character.toString(
                        ReflectionUtils.PackageType.getServerVersion().charAt(3)));
                if (version > 7) {
                ...
                sendPacket = ReflectionUtils.getMethod(playerConnection
                        .getType(), "sendPacket", ReflectionUtils.PackageType.MINECRAFT_SERVER
                        .getClass("Packet"));
        ...
        private void initializePacket(Location center) throws PacketInstantiationException {
            ...
            try {
                ...
                if (version < 8) {
                    ...
                    ReflectionUtils.setValue(this.packet, true, "a", enumParticle
                            .getEnumConstants()[this.effect.getId()]);
                    ...
                    if (this.data != null) {
                        ...
                        ReflectionUtils.setValue(this.packet, true, "k",
                                (this.effect == ParticleEffect.ITEM_CRACK) ? packetData : new int[1]);
                    }
                }
        ...
        public void sendTo(Location center, Player player) throws PacketInstantiationException, PacketSendingException {
            ...
            try {
                sendPacket.invoke(playerConnection
                        .get(getHandle.invoke(player)), this.packet);
            } catch (Exception exception) {
        ...
        public void sendTo(Location center, double range) throws IllegalArgumentException {
            ...
            for (Player player : Bukkit.getOnlinePlayers()) {
                if (!player.getWorld().getName().equals(worldName) || player
                        .getLocation().distanceSquared(center) > squared) {
                    continue;
                }
                sendTo(center, player);
            }
